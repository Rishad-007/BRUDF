...
const HomeSection = ({ onJoinClick }) => (
  <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 via-purple-50 to-teal-100 overflow-hidden pt-24 lg:pt-28">
    ...
    <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      ...
      <div className="mb-8 lg:mb-10 relative">
        ...
        <img
          src="/logo brudf.png"
          alt="BRUDF Logo"
          className="relative mx-auto w-28 sm:w-36 md:w-44 lg:w-52 xl:w-56 drop-shadow-2xl hover:scale-105 transition-transform duration-300"
        />
      </div>

      {/* Main heading with gradient text */}
      <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-extrabold bg-gradient-to-r from-indigo-600 via-purple-600 to-teal-600 bg-clip-text text-transparent mb-4 lg:mb-6 leading-tight">
        Begum Rokeya University
        <span className="block text-xl sm:text-2xl md:text-3xl lg:text-5xl xl:text-6xl mt-1 lg:mt-2">
          Debate Forum
        </span>
        <span className="block text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-semibold text-indigo-500 mt-1 lg:mt-2">
          (BRUDF)
        </span>
      </h1>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 lg:p-8 shadow-xl border border-white/20">
          ...
          <div className="text-sm sm:text-base lg:text-lg text-gray-700 space-y-4 text-left">
            <p className="leading-relaxed">
              ...
              <b>Core debate Club </b> of Begum Rokeya University,
              Rangpur.
            </p>
